...
aws ecr get-login-password --region ap-northeast-2 | docker login --username AWS --password-stdin 160226155671.dkr.ecr.ap-northeast-2.amazonaws.com
...
docker tag my-blog-app:1.0.0 160226155671.dkr.ecr.ap-northeast-2.amazonaws.com/dev/my-repo:my-blog-app-1.0.0

# 이미지를 ECR로 푸시
docker push {AWS_ACCOUNT_ID}.dkr.ecr.ap-northeast-2.amazonaws.com/{repo}/{appname}
docker push 160226155671.dkr.ecr.ap-northeast-2.amazonaws.com/dev/my-repo:my-blog-app-1.0.0
